...
<div class="row">
	The maximum value is   <span class ="dc-number" id="max-value"></span>.
    </div>
...
d3.json('<?php echo base_url(); ?>ajax/get_portfolio_stock_price/<?php echo $id?>', function (data) {
	...
	console.log(valueOfPortoflioGroup.top(1)[0]['value']);
    ...
    portfolioValueChart
       // .renderArea(true)
        ...
        .group(valueOfPortoflioGroup, 'Monthly Index Average')
